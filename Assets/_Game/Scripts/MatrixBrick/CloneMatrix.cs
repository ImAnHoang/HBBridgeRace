...
public class CloneMatrix : MonoBehaviour
{
    ...
    private void CreateBrick()
    {
        ...
        foreach (Vector2Int position in positions)
        {
            ...
            Maxtrix_Bricks[position.x, position.y].transform.gameObject.GetComponent<MeshRenderer>().enabled = false;
            Maxtrix_Bricks[position.x, position.y].transform.gameObject.tag = "Untagged";
        ...
        transform.position = new Vector3(13f, 26.3f, 61f);
